/* INPUT:-A FILE CONTAINING FOLLOWING DETAILS FOR SOME n,GRAPH WITH n VERTICES IN THE FORMAT:-
                 ...
                 .
                 Vn:(ei,wi)(ej,wj)
 WHERE EACH e IS AN EDGE AND w IS IT'S WEIGHT WHICH IS A POSITIVE INTEGER      
